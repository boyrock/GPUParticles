...
public class Instancing : MonoBehaviour {
    ...
    void Update ()
    {
        ...
        {
            var pos = Camera.main.ScreenToWorldPoint(new Vector3(Input.mousePosition.x, Input.mousePosition.y, 100f));

            var newParticles = emitter.Emit(Emitter.EmitShapeType.Circle, pos, 1f);
            AddParticles(newParticles);
        }
